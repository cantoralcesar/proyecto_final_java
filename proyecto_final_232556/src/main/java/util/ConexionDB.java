...
public class ConexionDB {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/cac_integrador";
    private static final String USER = "root";
    private static final String PASSWORD = "";
    
    // Bloque estático (static {} )
    // Un bloque estático es una sección de código que se ejcuta una sola vez, cuando la clase es cargada por el ClassLoader de Java.
